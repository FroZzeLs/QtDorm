...
public:
    ...
    void setupUi(QDialog *ReportsWindow)
    {
        ...
        ReportsWindow->resize(241, 395);
        label = new QLabel(ReportsWindow);
        label->setObjectName("label");
        label->setGeometry(QRect(70, 10, 101, 41));
        QFont font;
        font.setFamilies({QString::fromUtf8("Times New Roman")});
        font.setPointSize(22);
        font.setBold(true);
        label->setFont(font);
        exit = new QPushButton(ReportsWindow);
        exit->setObjectName("exit");
        exit->setGeometry(QRect(130, 350, 93, 41));
...
"}"));
        ...
        groupBox->setGeometry(QRect(10, 60, 221, 281));
...
""));
        ...
        layoutWidget->setGeometry(QRect(10, 0, 201, 281));
        verticalLayout = new QVBoxLayout(layoutWidget);
        verticalLayout->setSpacing(5);
        verticalLayout->setObjectName("verticalLayout");
        verticalLayout->setContentsMargins(0, 0, 0, 0);
        allStudents = new QPushButton(layoutWidget);
...
"}"));
        ...
        verticalLayout->addWidget(allStudents);

        debtors = new QPushButton(layoutWidget);
...
"}"));
        ...
        verticalLayout->addWidget(debtors);

        studentCouncil = new QPushButton(layoutWidget);
...
"}"));
        ...
        verticalLayout->addWidget(studentCouncil);

        dd = new QPushButton(layoutWidget);
        dd->setObjectName("dd");
        dd->setFont(font1);
...
"}"));
    ...
    void retranslateUi(QDialog *ReportsWindow)
    {
        ...
        exit->setText(QCoreApplication::translate("ReportsWindow", "\320\227\320\260\320\272\321\200\321\213\321\202\321\214", nullptr));
